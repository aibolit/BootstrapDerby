 ...
 * performance benefits of the embedded driver as well as allow for client
...
public class BootRun {
     ...
     */
    private static String DBNAME = "PUZZLEHUNT";
     ...
     * cause the Network Server to start as soon as Derby is loaded.
     *
     ...
     *
     * Alternatively, the Network Server might be started from the command line
     * or from some other program. Note: only the JVM that starts Network Server
     * can make an embedded connection.
     */
     ...
     * property or or in the derby.properties file. Setting this property to
     * true starts the Network Server when Derby boots up. The port at which the
     * Derby Network Server listens can be changed by setting the
    ...
    private static void startWithProperty() throws Exception {
        ...
        System.setProperty("derby.user.apple", "cherry");
     ...
     * successful, it returns; otherwise, it tries for 50 seconds before giving
     * up and throwing an exception.
     *
     * @throws Exception when there is a problem with testing if the Network
     ...
     * method Alternatively, if the Derby Network Server is started in this JVM,
     ...
     * @param attributes attributes for the database connection (for example,
    ...
    /**
     * This method waits until the user presses Enter to stop the server and
     * eventually exit this program Allows clients to continue to connect using
     * client connections from other JVMs to the Derby Network Server that was
